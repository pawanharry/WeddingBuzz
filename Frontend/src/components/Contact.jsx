...
function Contact() {
  return (
   ...
   <section id="section6" class=" dark:bg-slate-800" >
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20 border-4 border-orange-200 border-t-orange-500">
        <div class="mb-4">
            <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
               
                <h2
                    class="font-heading mb-4 font-bold tracking-tight text-gradient-to-br from-pink-400 to-orange-500  text-3xl sm:text-5xl">
                    Get in Touch
                </h2>
                <p class="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400">Your Personal Wedding Planner
                </p>
            </div>
        </div>
        <div class="flex items-stretch justify-center">
            <div class="grid md:grid-cols-2">
                <div class="h-full pr-6">
                    ...
                    Your wedding, your way. Affordable luxury awaits with our tailored pricing.
                    </p>
                    <ul class="mb-6 md:mb-0">
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-gradient-to-br from-pink-400 to-orange-500 text-gray-50">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">1230 Toronto Street </p>
                                <p class="text-gray-600 dark:text-slate-400">Toronto, CA</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-gradient-to-br from-pink-400 to-orange-500 text-gray-50">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">Mail: weddingbuzzt@gmail.com</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-gradient-to-br from-pink-400 to-orange-500 text-gray-50">
